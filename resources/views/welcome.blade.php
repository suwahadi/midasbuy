...
<div class="header">
    <div class="main g-clr">
        ...
        <div class="menu-nav-box">
            <ul>
                <li class="acitve navIndexButton"><a href="javascript:void(0)" cr="homepage">Beranda</a></li>
                <!-- <li><a href="/events/">Pusat Event</a></li>
        ...
        <div class="section hot-game">
            ...
            <div class="list-box">
                <ul>
                    ...
                    <li class="list">
                        <a cr="topup.1450015065" href="/midasbuy/id/shop/pubgm">
                            
                            <div class="type-label" limit="12">Populer</div>
                            
                            <div class="pic">
                                <img src="//midas.gtimg.cn/midasbuy/images/PUBGM_index_games.png" alt="img"/>
                            </div>
                            <div class="mask"></div>                     
                    ...
                    <li class="list">
                        <a cr="topup.1450017788" href="/midasbuy/id/buy/pubgmlite">
                            
                            <div class="pic">
                                <img src="//midas.gtimg.cn/oversea_web/static/images/lite_index_games.png" alt="img"/>
                            </div>
                            <div class="mask"></div>
                    ...
                    <li class="list">
                        <a cr="topup.1450021922" href="/midasbuy/id/buy/chessrush">
                            
                            <div class="pic">
                                <img src="//midas.gtimg.cn/oversea_web/static/images/cr_index_games.png" alt="img"/>
                            </div>
                            <div class="mask"></div>
                    ...
                    <li class="list">
                        <a cr="topup.1450023210" href="/midasbuy/id/shop/hayday">
                            
                            <div class="pic">
                                <img src="//midas.gtimg.cn/oversea_web/static/image/hayday/236x278.jpg" alt="img"/>
                            </div>
                            <div class="mask"></div>
